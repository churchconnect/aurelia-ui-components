...
System.register(['./pull-to-refresh', './page-header', './page-body', './page-footer'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_pullToRefresh) {
      ...
      for (var _key4 in _pageFooter) {
        if (_key4 !== "default" && _key4 !== "__esModule") _exportObj4[_key4] = _pageFooter[_key4];
      }
